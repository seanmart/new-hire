<template>
  ...
  :class="{'bg-fuchsia-50 border-fuchsia-200 text-fuchsia-800':data.completed}">
    ...
    <div class="mr-3 w-8 sm:w-10 p-0 flex-shrink-0 flex-grow-0 flex items-center justify-center relative">
      ...
      <div v-else class="w-6 h-6 sm:w-8 sm:h-8 border-2 border-shade-300 rounded"/>
    </div>
